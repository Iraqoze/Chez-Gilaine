...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailEDT=findViewById(R.id.editText_reg_email);
    ...
    private void saveUserInfo(String userId, User user){
        ...
        firestore.collection("RESTAURANTS").document("USERS").collection(userId).add(user)
                .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentReference> task) {
                        ...
                        if (task.isSuccessful()){
                            //end
                            Toast.makeText(RegisterActivity.this, "Registration is successfull", Toast.LENGTH_LONG).show();
